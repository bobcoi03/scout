import { ProductIntelligence, type IntelligenceSignal, type ThemeName } from "@/components/product-intelligence";
...
export async function ProductWorkspace({
  ...
  return <ProductIntelligence signals={signals} from={from} to={to} initialView={initialView} initialTheme={initialTheme} />;
}
